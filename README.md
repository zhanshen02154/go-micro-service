...
## 项目描述
以“订单支付成功回调扣减商品库存”链路进行微服务架构演进实践，总体架构为云原生架构，分为订单服务和商品服务（支付服务和订单服务合并），商品服务和库存服务合并以减少服务器的使用。
各服务为领域驱动架构，包含领域层、应用层、基础设施层、接口层，所有逻辑全部重写，基本实现去中心化。

为提升吞吐量，项目从3.0开始将DTM分布式事务替换为事件驱动架构，当前版本为5.0，4.0及以下版本停止维护，包含死信队列，幂等性保障及异步生产者。

项目管理工具为Github Project，采用Scrum进行项目管理，迭代周期为2周。

## 项目特点
- 由网课教程改造而成，原版无法实现跨服务通信且仅有领域层，
